...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'dubins.wast';
  var wasmBinaryFile = 'dubins.wasm';
  var asmjsCodeFile = 'dubins.temp.asm.js';
...
var real__dubins_extract_subpath = asm["_dubins_extract_subpath"]; asm["_dubins_extract_subpath"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var _dubins_extract_subpath = Module["_dubins_extract_subpath"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
